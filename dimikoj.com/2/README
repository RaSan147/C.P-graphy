...
### ইনপুট
> প্রথম লাইনে একটি সংখ্যা `T (1≤T≤100)` দেওয়া থাকবে। পরবর্তীতে `T` -এর মান যত, ততটি লাইন থাকবে।
> প্রতিটি লাইনে একটি করে পূর্ণসংখ্যা `N` দেওয়া থাকবে। একটি সংখ্যায় সর্বোচ্চ `100টি অঙ্ক (digit)` থাকতে পারে।
